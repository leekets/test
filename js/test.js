$(function() {
    ...
    function act() {
        ...
        // alert(index+":"+eNum);
        // if(rNum==0){
        if ((index <= 5 && eNum == 3)) { < !--include file = "js_repeat2.asp"-->
        }
        if ((index > 5 && index <= 10 && eNum == 5)) { < !--include file = "js_repeat2.asp"-->
        }
        if ((index > 10 && index <= 15 && eNum == 7)) { < !--include file = "js_repeat2.asp"-->

        }
        if ((index > 15 && index <= 20 && eNum == 9)) { < !--include file = "js_repeat2.asp"-->
        }
        if ((index > 20 && index <= 25 && eNum == 11)) { < !--include file = "js_repeat2.asp"-->
        }
        if ((index > 25 && index <= 30 && eNum == 13)) { < !--include file = "js_repeat2.asp"-->
    ...
    function act3() {
        ...
        // $("a.btn1").hide();
        $("a.btnP").show();
        audio = document.getElementById('player') play3(1);
    ...
    $("a.btn1").click(function() {
        ...
        if ($("textarea.b").val().replace(/>/g, "&gt;").toLowerCase() == $("b.a").html().toLowerCase()) {
            ...
            act3();
            eNum += 1 errors.push(comments[index - 1]);
            // console.log(errors);
